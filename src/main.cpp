...
int main() {
    ...
    Vector3 center(0,-0.25,0);
    Color color(0.18,0.35,0.55);
    Vector3 dim(4,4,4);
    ...
    std::shared_ptr<ImageTexture> texture = std::make_shared<ImageTexture>("src/textures/fleurs.png");
    Material material(1.2, 500, 0.00f,texture);
    Sphere sphere(Vector3(0, -0.25, 0), 1.0f, Color(1, 1, 1), material);
